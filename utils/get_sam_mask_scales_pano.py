...
parser.add_argument("--down_sample_factor_override", type=int, default=None)
...
try:
    ...
    if args.down_sample_factor_override is not None:
        setattr(dataparser_config, "down_sample_factor", args.down_sample_factor_override)
        print(f"Override down sample factor to {args.down_sample_factor_override}")
